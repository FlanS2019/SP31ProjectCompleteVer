...
// 初期化処理
//=============================================================================
HRESULT PixelLightingBlinPhong::Init(void)
{
	//シェーダー読み込み
	CreateVertexShader(&VertexShader, &VertexLayout, "PixelLightingBlinPhongVS.cso");
...
// 終了処理
//=============================================================================
void PixelLightingBlinPhong::Finalize(void)
{
	//作ったものを解放
...
// 更新処理
//=============================================================================
void PixelLightingBlinPhong::Update(void)
{
...
// 描画処理
//=============================================================================
void PixelLightingBlinPhong::Draw(void)
{
	// 頂点レイアウト設定
